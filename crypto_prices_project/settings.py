"""
Django settings for crypto_prices_project project.
...
SECRET_KEY = 'django-insecure-ol)632zu#e^@51fagku%_6ri)@80@en)$j&d0wqy_7knn#th@!'
...
# Specify the path to the log directory within your project
